...
class LoggingToFile():
    def __init__(self):
        self.f = open('backtestingloggingfile.dat', 'a')
...
class StrategyTemplate(object):
    ...
    def logging(self, s):
        if not hasattr(self, "logFile"):
            self.logFile = open("CTP_Strategy_signals", "a")            
        current_time = time.strftime("%Y-%m-%d %H:%M:%S", time.localtime())
#        self.logFile.write(current_time + "  " + s + "\n")
        self.logFile.write(current_time  + "Stub Stub" + "\n")
        self.logFile.flush()             

    #----------------------------------------------------------------------
    def getDataByOffset(self, data, offset):
        return self.ctaEngine.getDataByOffset(data, offset)
    ...
    def buy(self, price, volume, stop=False):
        """买开"""
        logging.logging('buy ' + str(volume) + ' price: ' + str(price))
        return self.sendOrder(CTAORDER_BUY, price, volume, stop)
    
    #----------------------------------------------------------------------
    def sell(self, price, volume, stop=False):
        """卖平"""
        logging.logging('sell ' + str(volume) + ' price: ' + str(price))
        return self.sendOrder(CTAORDER_SELL, price, volume, stop)       

    #----------------------------------------------------------------------
    def short(self, price, volume, stop=False):
        """卖开"""
        logging.logging('short ' + str(volume) + ' price: ' + str(price))
        return self.sendOrder(CTAORDER_SHORT, price, volume, stop)          
 
    #----------------------------------------------------------------------
    def cover(self, price, volume, stop=False):
        """买平"""
        logging.logging('cover ' + str(volume) + ' price: ' + str(price))
